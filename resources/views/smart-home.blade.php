<x-layout>
    ...
    <div class="bg-white in-dark:bg-greycode-gray min-h-screen">
        ...
        <section class="container mx-auto px-6 sm:px-8 lg:px-16 py-8 flex items-center space-y-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div class="px-4 space-y-6">
                    <h2 class="text-4xl lg:text-5xl font-bold mb-4"><span class="text-greycode-light-blue">Smart</span> Home</h2>
                    <p class="text-left leading-relaxed max-w-3xl">Transform your home into a haven of convenience and security with our Smart Home solutions. Experience unparalleled comfort and peace of mind as innovative technologies seamlessly integrate into your daily life. Control lighting, temperature, and security systems effortlessly with your smartphone or voice commands and enjoy personalized settings that adapt to your preferences, ensuring a cozy, safe, and efficient living environment.</p>
                </div>
                <div class="px-4">
                    <img src="{{ asset('images/65f021bb88b9105a4ceb964a_6599da1f1df5a8f2567872aa_smart_home-removebg-preview 1.jpg')}}" alt="smart home" class="w-full max-w-md">
                </div>
            </div>
        </section>
        ...
        <section class="container mx-auto px-6 sm:px-8 lg:px-16 py-8 space-y-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div class="px-4">
                    <img src="{{ asset('images/65f0223229a4a29b4b3497cd_buildings 1.jpg')}}" alt="smart building" class="w-full max-w-md">
                </div>
                <div class="px-4 space-y-6">
                    <h2 class="text-4xl lg:text-5xl font-bold mb-4"><span class="text-greycode-light-blue">Smart</span> Building</h2>
        ...
        <section class="container mx-auto px-10 sm:px-8 lg:px-20 py-8 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 lg:gap-16">
                ...
                <div class="card bg-white w-full h-96 shadow-xl border-2 border-gray-200 rounded-2xl hover:shadow-2xl transition-all duration-300 p-6 flex flex-col justify-between">
                    ...
                    <div class="flex flex-col justify-between h-full">
                        <div>
                            <h3 class="card-title text-xl font-bold mb-4 text-greycode-dark-blue">Proactive Building Maintenance</h3>
                            <p class="text-gray-600 leading-relaxed">Our IoT sensors constantly monitor the building's infrastructure. This enables predictive maintenance, averting breakdowns and prolonging the lifespan of equipment, from elevators to HVAC systems.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card bg-white w-full h-96 shadow-xl border-2 border-gray-200 rounded-2xl hover:shadow-2xl transition-all duration-300 p-6 flex flex-col justify-between">
                    ...
                    <div class="flex flex-col justify-between h-full">
                        <div>
                            ...
                            <p class="text-gray-600 leading-relaxed">Our platform enables building managers to monitor and control system operations from anywhere, ensuring constant oversight and quick response capabilities.</p>
                        </div>
                    </div>
                </div>
            </div>
