<x-layout>
    ...
    {{-- <section id="vision" class="py-12 sm:py-16 lg:py-20 bg-gray-50 dark:bg-gray-900">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Section Header -->
        <div class="text-center mb-12 sm:mb-16">
            <h2 class="text-3xl sm:text-4xl lg:text-5xl font-bold">
                Our <span class="text-greycode-light-blue">vision</span>
            </h2>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div class="space-y-8 lg:space-y-12">
                ...
                <div class="relative bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div class="absolute -top-4 -left-2 text-7xl font-bold text-greycode-light-blue/10">01</div>
                    <div class="relative z-10">
                        ...
                        <p class="text-gray-600 dark:text-gray-400">
                            Connecting people seamlessly to a smarter, safer and more fulfilling world.
                        </p>
                    </div>
                </div>

                <!-- Visual Element - Replacing Image Grid -->
                <div class="bg-gradient-to-br from-greycode-light-blue to-blue-600 rounded-xl p-8 text-white">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="text-center">
                            <div class="text-4xl mb-2">🌐</div>
                            <p class="text-sm font-medium">Global Connectivity</p>
                        </div>
                        <div class="text-center">
                            <div class="text-4xl mb-2">🔗</div>
                            <p class="text-sm font-medium">IoT Integration</p>
                        </div>
                        <div class="text-center">
                            <div class="text-4xl mb-2">🏢</div>
                            <p class="text-sm font-medium">Smart Cities</p>
                        </div>
                        <div class="text-center">
                            <div class="text-4xl mb-2">⚡</div>
                            <p class="text-sm font-medium">Real-time Data</p>
                        </div>
                    </div>
                </div>
                ...
                <!-- Vision Block 04 -->
                <div class="relative bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div class="absolute -top-4 -left-2 text-7xl font-bold text-greycode-light-blue/10">04</div>
                    <div class="relative z-10">
                        <h3 class="text-xl sm:text-2xl font-semibold mb-4 text-gray-900 dark:text-white">
                        ...
                        <p class="text-gray-600 dark:text-gray-400">
                            Imagine a world where everyone and everything is connected.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-8 lg:space-y-12">
                <!-- Vision Block 02 -->
                <div class="relative bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div class="absolute -top-4 -left-2 text-7xl font-bold text-greycode-light-blue/10">02</div>
                    <div class="relative z-10">
                        <h3 class="text-xl sm:text-2xl font-semibold mb-4 text-gray-900 dark:text-white">
                ...
                <!-- Vision Block 03 -->
                <div class="relative bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div class="absolute -top-4 -left-2 text-7xl font-bold text-greycode-light-blue/10">03</div>
                    <div class="relative z-10">
                        <h3 class="text-xl sm:text-2xl font-semibold mb-4 text-gray-900 dark:text-white">
                            To create a world-class IoT platform to connect everything, everyone and our experiences
                        </h3>
                        <p class="text-gray-600 dark:text-gray-400">
                            Impact the world by improving the connection between people and their environment
                        </p>
                    </div>
                </div>
                ...
                <!-- Vision Block 05 -->
                <div class="relative bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div class="absolute -top-4 -left-2 text-7xl font-bold text-greycode-light-blue/10">05</div>
                    <div class="relative z-10">
                        <h3 class="text-xl sm:text-2xl font-semibold mb-4 text-gray-900 dark:text-white">
                        ...
                        <p class="text-gray-600 dark:text-gray-400">
                            The amount of information being generated and captured today is unprecedented. Our vision is to not only capture all of your data, but also be able to make sense of it in real-time and action upon it.
                        </p>
                    </div>
                </div>
            </div>
...
<section id="vision" class="py-12 sm:py-16 lg:py-20 bg-gray-50 dark:bg-gray-900">
    <div class="container mx-auto px-10 sm:px-6 lg:px-8">
        <!-- Section Header -->
        <div class="text-center mb-12 sm:mb-16">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div class="space-y-8 lg:space-y-12">
                ...
                <div class="relative bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg hover:shadow-xl shadow-greycode-light-blue transition-shadow duration-300">
                    ...
                    <div class="absolute bottom-4 right-4 text-4xl font-bold text-greycode-light-blue/20 dark:text-greycode-light-blue/30">01</div>
                </div>
                ...
                <div class="relative bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg hover:shadow-xl shadow-greycode-light-blue transition-shadow duration-300">
                    ...
                    <div class="absolute bottom-4 right-4 text-4xl font-bold text-greycode-light-blue/20 dark:text-greycode-light-blue/30">02</div>
                </div>
                ...
                <div class="relative bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg hover:shadow-xl shadow-greycode-light-blue transition-shadow duration-300">
                    ...
                    <div class="absolute bottom-4 right-4 text-4xl font-bold text-greycode-light-blue/20 dark:text-greycode-light-blue/30">03</div>
                </div>
            </div>
            ...
            <div class="space-y-8 lg:space-y-12">
                ...
                <div class="relative bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg hover:shadow-xl shadow-greycode-light-blue transition-shadow duration-300">
                    ...
                    <div class="absolute bottom-4 right-4 text-4xl font-bold text-greycode-light-blue/20 dark:text-greycode-light-blue/30">04</div>
                </div>
                ...
                <div class="relative bg-white dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg hover:shadow-xl shadow-greycode-light-blue transition-shadow duration-300">
                    ...
                    <div class="absolute bottom-4 right-4 text-4xl font-bold text-greycode-light-blue/20 dark:text-greycode-light-blue/30">05</div>
                </div>
            </div>
        </div>
    </div>
