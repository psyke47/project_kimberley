    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 md:p-8">
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="lg:w-2/3">
                ...
                <!-- Blog Name -->
                <h2 class="text-2xl md:text-3xl font-bold text-gray-900 mb-3">Youth Unemployment in Africa: Part 1 - The Removal of Work Experience</h2>
            ...
            <div class="lg:w-1/3">
                ...
                <hr class="border-black-400 mt-4 mb-6">
                
                <!-- Stacked Articles -->
                <div class="space-y-6">
                    
                    <!-- Article 1 -->
                    <div class="flex items-start gap-4 pb-6 border-b border-black">
                        <img src="{{ asset('images/article1.jpg') }}" alt="Article 1" class="w-20 h-20 object-cover rounded-lg flex-shrink-0">
                        <div>
                            <h4 class="font-semibold text-gray-900 mb-1">The Importance of IoT in the Energy Sector</h4>
