    ...
    <div class="container mx-auto">
        <div class="flex justify-center space-x-9">
            ...
            <div class="flex flex-col items-center space-y-2">
                ...
                <p class="text-black hover:text-white text-[12px]">TikTok</p>
            </div>
            <div class="flex flex-col items-center space-y-2">
                ...
                <p class="text-black text-[12px]">LinkedIn</p>
            </div>
            <div class="flex flex-col items-center space-y-2">
                ...
                <p class="text-black text-[12px]">Instagram</p>
            </div>  
            <div class="flex flex-col items-center space-y-2">
            ...
            <div class="flex flex-col items-center space-y-2">
                ...
                <p class="text-black text-[12px]">YouTube</p>
            </div>
        </div>
        <div>
            <p class="text-center mt-4">We are based in this 13 Stamvrug St, Val De Grace, Pretoria, 0184</p>
        </div>
        <div class="form">
