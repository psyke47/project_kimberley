<nav class="flex items-center justify-between py-2 px-4 lg:px-20 sticky top-0 left-0 right-0 z-50 min-h-[60px] bg-white dark:bg-gray-800 transition-colors duration-300" role="navigation">
    ...
    <div class="hidden lg:flex lg:items-center lg:gap-6">
        <ul class="flex items-center gap-6 text-base font-medium">
            ...
            <li><a href="https://store.greycode.co.za/" class="text-greycode-light-blue dark:text-white hover:text-gray-400 transition-colors duration-300 py-1 dark:text-blue-400 dark:hover:text-blue-300">Shop</a></li>
    ...
    <div class="lg:hidden flex items-center gap-4">
        ...
        <div id="mobile-menu" class="absolute top-full left-0 w-full bg-white shadow-lg py-4 hidden z-50 dark:bg-gray-800 transition-colors duration-300">
            <div class="flex flex-col items-center gap-3 text-base font-medium">
                ...
                <a href="https://store.greycode.co.za/" class="text-greycode-light-blue hover:text-gray-400 transition-colors duration-300 py-2 w-full text-center dark:text-blue-400 dark:hover:text-blue-300">Shop</a>
                ...
                <a href="https://courses.greycode.co.za/courses/"><button class="bg-greycode-light-blue text-white px-4 py-2 font-medium rounded-md hover:bg-gray-800 transition-colors duration-300 mt-2 dark:bg-blue-600 dark:hover:bg-blue-700">Education</button></a>
            </div>
        </div>
    </div>
</nav>
