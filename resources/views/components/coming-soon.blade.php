...
<body style="background-image: url('{{ asset('images/under-contruction.jpg') }}');" class="bg-cover bg-center min-h-screen flex items-center justify-center bg-greycode-dark-blue bg-blend-overlay">
    <div class="w-full  px-6 sm:px-8 lg:px-12 py-16 sm:py-24 backdrop-blur-sm/0">
        <div class="container lg:p-20 justify-center-safe mt-40 text-center space-y-8 text-white mx-auto">
            <h1 class="text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl  mix-blend-brighten sm:font-extrabold">Coming <span class="text-greycode-light-blue">Soon</span></h1>
